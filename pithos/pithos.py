...
class PithosWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, app, test_mode):
        ...
        self.volume = self.get_template_child('volume')
        self.playpause_image = self.get_template_child('playpause_image')
        self.statusbar = self.get_template_child('statusbar')
        self.song_menu = self.get_template_child('song_menu')
        self.song_menu_love = self.get_template_child('song_menu_love')
        self.song_menu_unlove = self.get_template_child('song_menu_unlove')
        self.song_menu_ban = self.get_template_child('song_menu_ban')
        self.song_menu_unban = self.get_template_child('song_menu_unban')
        self.songs_treeview = self.get_template_child('songs_treeview')
        self.stations_button = self.get_template_child('stations_button')
        self.stations_label = self.get_template_child('stations_label')
        self.api_update_dialog_real = self.get_template_child('api_update_dialog_real')
        self.error_dialog_real = self.get_template_child('error_dialog_real')
        self.fatal_error_dialog_real = self.get_template_child('fatal_error_dialog_real')
